...
${chalk.bold('Usage:')}
  npx tsx scripts/ai-code-improvement.js --file <filepath> [options]
...
${chalk.bold('Examples:')}
  npx tsx scripts/ai-code-improvement.js --file lib/utils.ts --dry-run
  npx tsx scripts/ai-code-improvement.js --file components/message.tsx --output components/message.improved.tsx
  `);
