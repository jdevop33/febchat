  ...
  contextFiles: [
    {
      ...
      prompt:
        "Create a comprehensive architecture overview document explaining how the application is structured. Include sections on the application layers, key components, data flow, and the reasoning behind the architectural decisions.",
    ...
    },
    {
      ...
      prompt:
        "Create a document explaining the component system used in this Next.js application. Focus on the UI components, their organization, patterns, and best practices for using them.",
    ...
    },
    {
      ...
      prompt:
        "Create a document explaining the UI primitives system in this application. Focus on the base UI components, their design principles, customization options, and how they should be composed.",
      matchPatterns: ["components/ui/**/*.tsx"],
    },
    {
      name: "data-layer.md",
      prompt:
        "Create a document explaining the data layer and database interactions in this application. Focus on the database schema, queries, and data flow.",
      matchPatterns: ["lib/db/**/*.ts"],
    },
    {
      name: "authentication.md",
      prompt:
        "Create a document explaining the authentication system in this application. Include details on the authentication flow, user management, and security considerations.",
      matchPatterns: ["app/(auth)/**/*.ts", "app/(auth)/**/*.tsx"],
    },
    {
      name: "api-routes.md",
      prompt:
        "Create a document explaining the API routes in this application. Include details on the endpoints, their functionality, request/response formats, and error handling.",
      matchPatterns: ["app/api/**/*.ts", "app/(chat)/api/**/*.ts"],
    },
    {
      name: "state-management.md",
      prompt:
        "Create a document explaining the state management approach in this application. Focus on how state is managed across components and pages.",
      matchPatterns: ["hooks/**/*.ts", "hooks/**/*.tsx"],
    },
    {
      name: "development-workflow.md",
      prompt:
        "Create a document explaining the development workflow for this application. Include information on building, testing, linting, and deployment processes based on the package.json scripts and project structure.",
...
${Object.keys(packageInfo.dependencies)
  .map((dep) => `- ${dep}: ${packageInfo.dependencies[dep]}`)
  .join("\n")}
...
5. Best practices and guidelines`;
    ...
    console.error(
      chalk.red(`Error generating context file ${contextFile.name}:`),
      error,
    );
    return false;
  }
