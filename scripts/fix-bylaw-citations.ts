  ...
  '4742': [
    {
      ...
      content:
        'Except as authorized by a Permit issued under this Bylaw, no person shall cut, remove or damage any Protected Tree.',
    },
    {
      sectionNumber: '2.1',
      title: 'Protected Tree Definition',
      content:
        'Protected Tree means any of the following: (a) any tree with a DBH of 60 cm or greater; (b) an Arbutus, Dogwood, Garry Oak, or Western White Pine tree with a DBH of 10 cm or greater; (c) a Western Red Cedar or Big Leaf Maple tree with a DBH of 30 cm or greater.',
    },
    {
      sectionNumber: '10.1',
      title: 'Penalties',
      content:
        'A person who violates any provision of this Bylaw commits an offence and upon conviction is liable to a fine not exceeding $10,000.',
    },
  ],
  ...
  '4013': [
    {
      ...
      title: 'Dogs At Large',
      content:
        'No person shall permit a dog to be on any street or public place or in any public building unless the dog is kept on a leash not exceeding 6 feet in length and is under the immediate control of a competent person.',
    },
    {
      sectionNumber: '7',
      title: 'Dog Licence Fee',
      content:
        'Every application for a licence shall be accompanied by a licence fee in the amount of $30.00 for each dog that is neutered or spayed, or $45.00 for each dog that is not neutered or spayed.',
    },
    {
      sectionNumber: '9',
      title: 'Dog Beach Restrictions',
      content:
        'No person shall permit a dog to be on any public beach, whether on a leash or not, in the area between the westerly municipal boundary of The Corporation and the easterly boundary of Lot 1, Section 46, Plan 2193 (known as the "Oak Bay Marina") between May 1 and September 30 in any year.',
    },
  ],
  ...
  '3531': [
    {
      ...
      content:
        'The minimum lot area for a single family dwelling shall be 695 square metres (7,481 square feet).',
    },
    {
      sectionNumber: '6.5.1',
    ...
    },
    {
      ...
      content:
        'No more than one (1) secondary suite shall be permitted in any single family dwelling.',
    },
  ],
};
...
async function updateBylawData() {
  try {
    ...
    // Process each bylaw
    for (const [bylawNumber, sections] of Object.entries(
      accurateBylawSections,
    )) {
      ...
      console.log(
        `✅ Updated ${sections.length} sections for Bylaw ${bylawNumber}`,
      );
    }
