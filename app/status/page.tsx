    ...
    try {
      ...
      try {
        const pdfResponse = await fetch(
          "/api/bylaws/find-pdf?bylawNumber=3210",
          {
            cache: "no-cache",
          },
        );
      ...
      const isHealthy = newStatuses.every(
    ...
    <div className="container mx-auto max-w-4xl py-8">
      <div className="mb-8 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex items-center">
          <div
            className={`mr-2 flex h-6 w-6 items-center justify-center rounded-full ${systemStatus.healthy ? "bg-green-100" : "bg-red-100"}`}
          >
          ...
          <span
            className={`font-medium ${systemStatus.healthy ? "text-green-700" : "text-red-700"}`}
          >
      ...
      <div className="mt-8 rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
        ...
        <ul className="list-inside list-disc space-y-1">
          ...
          <li>
            PDF viewing issues can often be resolved by visiting the official
            website
          </li>
          <li>
            For persistent issues, please clear your browser cache and try again
          </li>
          <li>
            If database connectivity issues persist, contact your administrator
          </li>
        </ul>
      </div>
    </div>
