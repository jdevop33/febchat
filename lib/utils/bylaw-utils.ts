...
export function getExternalPdfUrl(bylawNumber: string, title?: string): string {
  ...
  const knownBylawUrls: Record<string, string> = {
    ...
    '3416': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/3416-Boulevard-Frontage-Tax-BL-1982-CONSOLIDATED-to-May-8-2023.pdf',
    '3531': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/3531_ZoningBylawConsolidation_Aug302024.pdf',
    '3545': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/3545-Uplands-Bylaw-1987-CONSOLIDATED-to-February-10-2020.pdf',
    '3578': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/3578_Subdivision-and-Development_CONSOLIDATED-to-September-2023.pdf',
    '4100': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4100-Streets-Traffic-Bylaw-2000.pdf',
    '4183': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4183_Board-of-Variance-Bylaw_CONSOLIDATED-to-Sept11-2023.pdf',
    '4371': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4371-Refuse-Collection-and-Disposal-Bylaw-2007-CONSOLIDATED.pdf',
    '4672': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4672-Parks-and-Beaches-Bylaw-2017-CONSOLIDATED.pdf',
    '4742': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4742-Tree-Protection-Bylaw-2020-CONSOLIDATED.pdf',
    '4844': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4844-Consolidated-up-to-4858.pdf',
    '4845': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4845-Planning-and-Development-Fees-and-Charges-CONSOLIDATED.pdf',
    '4849': 'https://www.oakbay.ca/sites/default/files/municipal-services/bylaws/4849-Property-Tax-Exemption-Bylaw-No-4849-2023.pdf',
  };
...
export function getBestPdfUrl(bylawNumber: string, title?: string): string {
  ...
  return isProduction ? getExternalPdfUrl(bylawNumber, title) : getLocalPdfPath(bylawNumber);
}
 ...
 */
export function findSectionPage(bylawNumber: string, section: string): number | null {
  ...
  if (sectionPageMapping[bylawNumber] && sectionPageMapping[bylawNumber][normalizedSection]) {
...
export const VALIDATED_BYLAWS = [
  '3152', '3210', '3370', '3416', '3531', '3536', '3540', '3545', '3550', 
  '3578', '3603', '3805', '3827', '3829', '3832', '3891', '3938', '3946', 
  '3952', '4008', '4013', '4100', '4144', '4183', '4222', '4239', '4247', 
  '4284', '4371', '4375', '4392', '4421', '4518', '4620', '4671', '4672', 
  '4719', '4720', '4740', '4742', '4747', '4770', '4771', '4772', '4777', 
  '4822', '4844', '4845', '4849', '4879', '4892', '4866', '4891', '4861',
];