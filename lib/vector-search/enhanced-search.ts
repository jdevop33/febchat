          ...
          if (verifiedBylaw.sections && verifiedBylaw.sections.length > 0) {
            ...
            verifiedBylaw.sections.forEach(section => {
              verifiedResults.push({
                ...
                consolidatedDate: verifiedBylaw.consolidatedDate,
                enactmentDate: verifiedBylaw.enactmentDate,
                amendedBylaw: verifiedBylaw.amendedBylaw
              });
            });
          } else {
            ...
            verifiedResults.push({
              ...
              title: verifiedBylaw.title,
              section: 'all',
              content: 'Full bylaw content unavailable. Please refer to the PDF.',
              score: 1.0,
              isVerified: true,
              pdfPath: verifiedBylaw.pdfPath,
              officialUrl: verifiedBylaw.officialUrl,
      ...
      for (const match of searchResults.matches) {
        ...
        if (verifiedBylaw) {
          ...
          verifiedResults.push({
            ...
            consolidatedDate: match.metadata.consolidatedDate as string | undefined,
          ...
          const similarBylaws = await VerificationDB.findSimilarBylaws(bylawNumber);
          if (similarBylaws.length > 0) {
            console.info(`Similar bylaws found: ${similarBylaws.map(b => b.bylawNumber).join(', ')}`);
          }
        }
      }
    }
