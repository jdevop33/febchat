...
export function AppErrorHandler({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      default:
        return {
          container:
            "border-gray-200 bg-gray-50/50 dark:border-gray-800/50 dark:bg-gray-900/20",
          icon: "text-gray-500",
  ...
  return (
    <div
      className={`my-4 flex flex-col items-center justify-center rounded-lg border p-6 ${styles.container}`}
    >
