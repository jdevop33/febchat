...
async function testConnection() {
  ...
  console.log('POSTGRES_URL:', process.env.POSTGRES_URL ? `${process.env.POSTGRES_URL.substring(0, 25)}...` : 'NOT SET');
  console.log('POSTGRES_URL_NON_POOLING:', process.env.POSTGRES_URL_NON_POOLING ? `${process.env.POSTGRES_URL_NON_POOLING.substring(0, 25)}...` : 'NOT SET');
  ...
  const connectionOptions = [
    ...
    { 
      ...
      url: process.env.POSTGRES_USER && process.env.POSTGRES_PASSWORD && process.env.POSTGRES_HOST && process.env.POSTGRES_DATABASE ? 
